...
import { Card, CardBody } from '@saltswap/uikit'
            ...
            <Column>
              <RowNoPadding>
                <CenteredTextWithPadding>
                  {TranslateString(442, 'Salty tickets matching 4 numbers:')}
                </CenteredTextWithPadding>
                <CenteredTextWithPadding>
              ...
              <RowNoPadding>
                <CenteredTextWithPadding>
                  {TranslateString(444, 'Salty tickets matching 3 numbers:')}
                </CenteredTextWithPadding>
                <CenteredTextWithPadding>
              ...
              <RowNoPadding>
                <CenteredTextWithPadding>
                  {TranslateString(446, 'Salty tickets matching 2 numbers:')}
                </CenteredTextWithPadding>
                <CenteredTextWithPadding>
