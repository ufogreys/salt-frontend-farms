...
import { getMasterChefAddress, getSaltAddress, getLotteryAddress, getLotteryTicketAddress } from 'utils/addressHelpers'
...
export const useCake = () => useERC20(getSaltAddress())
